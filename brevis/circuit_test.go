...
func TestCircuit(t *testing.T) {
	...
	from2 := common.HexToHash("0x3195ee2A3c4Cc67f448767faAdb061472e670223")
	...
	app.AddReceipt(sdk.ReceiptData{
		BlockNum: big.NewInt(18064071),
		TxHash:   common.HexToHash("0xb1116daed4d222a1460ab25597fddab6485bd83ca23b4b4527a745595085251b"),
		Fields: [sdk.NumMaxLogFields]sdk.LogFieldData{
			{Contract: usdcPool, LogIndex: 3, EventID: swapEvent, IsTopic: false, FieldIndex: 0, Value: amount0},  // field: USDCPool.Swap.amount0
			{Contract: usdcPool, LogIndex: 3, EventID: swapEvent, IsTopic: true, FieldIndex: 2, Value: recipient}, // field: USDCPool.Swap.recipient (topic field)
			{Contract: usdc, LogIndex: 2, EventID: transferEvent, IsTopic: true, FieldIndex: 1, Value: from2},     // field: USDC.Transfer.from
		},
	})
	...
	lengthOfArray := 2
	userAddrArr := make([]sdk.Uint248, lengthOfArray)
	userAddrArr[0] = sdk.ConstUint248(from)
	userAddrArr[1] = sdk.ConstUint248(from2)

	userAddrArr2 := make([]sdk.Uint248, 1)
	userAddrArr2[0] = sdk.ConstUint248(0)
